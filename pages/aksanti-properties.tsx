  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Properties page" />
      </Head>
      <HeroNoImage title='Aksanti Properties'>
      ...
      <AksantiAndText
        imgSrc='/aksanti-properties/aksanti.png'
        alt='mining'
      >
...
export default AksantiProperties